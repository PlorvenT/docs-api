...
class m190719_095103_create_order_table extends Migration
{
    ...
    public function safeUp()
    {
        ...
        $this->createTable('{{%order}}', [
            ...
            'clientSiteId' => $this->string(50)->notNull(),
            'client1cId' => $this->integer(11)->notNull(),
            'clientName' => $this->string(50)->notNull(),
            'clientEmail' => $this->string(50)->null(),
            'clientPhone' => $this->string(50)->notNull(),
            'clientCompany' => $this->string(50)->null(),
            'clientCommunicateChannel' => $this->string(50)->null(),
